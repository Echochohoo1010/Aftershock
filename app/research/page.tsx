      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="border-t-2 border-black dark:border-white pt-12">
          ...
          <div className="space-y-12">
            ...
            <div className="border-l-4 border-black dark:border-white pl-6 py-2">
              <h3 className="text-2xl font-bold mb-2">Complex Systems Optimization</h3>
              <p className="text-lg text-gray-700">
                Using causal inference to identify optimal policy mixes for complex systems  while minimizing
                economic disruption.
              </p>
            </div>
